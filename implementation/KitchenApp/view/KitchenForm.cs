...
namespace KitchenApp.view
{
    internal partial class KitchenForm : Form
    {
        ...
        {
            int width = (model.kitchen.map.GetUpperBound(0) - 1) * KitchenView.SQUARE_SIZE;
            int height = (model.kitchen.map.GetUpperBound(1) - 1) * KitchenView.SQUARE_SIZE;
        ...
        {
            Image tileImage = Image.FromFile("C:\\Users\\hp\\OneDrive\\Bureau\\KitchenApp\\assets\\tiles\\kitchen_tile.png");
            ...
            Image decorator1 = Image.FromFile("C:\\Users\\hp\\OneDrive\\Bureau\\KitchenApp\\assets\\decorator\\decorator-1.png");
            Image decorator2 = Image.FromFile("C:\\Users\\hp\\OneDrive\\Bureau\\KitchenApp\\assets\\decorator\\decorator-2.png");
            Image decorator3 = Image.FromFile("C:\\Users\\hp\\OneDrive\\Bureau\\KitchenApp\\assets\\decorator\\decorator-3.png");
