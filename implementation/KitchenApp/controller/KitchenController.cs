...
namespace KitchenApp.controller
{
    public class KitchenController
    {
        ...
        public Queue<Commodity> commodityQueue { get; set; }
        private static Mutex commodityQueueMut = new Mutex();
        private static ManualResetEvent commodityQueueMre = new ManualResetEvent(false);
        private static Mutex notifyCommodityQueueMut = new Mutex();
        ...
        public KitchenController(KitchenModel model, KitchenView view)
        {
            ...
            commodityQueue = new Queue<Commodity>();
        }   
